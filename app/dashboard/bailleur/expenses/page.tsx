...
export default function BailleurExpenses() {
  const {
    currentUser, expenses, properties, users,
      ...
      <motion.div variants={stagger.item} className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-1">
            Gérez vos dépenses liées à vos propriétés et confirmez les paiements effectués.
          </p>
        </div>
      ...
      <Modal isOpen={isCreateOpen} onClose={handleCloseCreate} title="Enregistrer une nouvelle dépense">
        <form onSubmit={createForm.handleSubmit(onCreateSubmit)} className="space-y-4 max-h-[65vh] overflow-y-auto pr-1">
          ...
          <div className="space-y-1.5">
            ...
            <Input id="c-titre" placeholder="ex: Prime d'assurance habitation — 2026"
          ...
          <div className="space-y-1.5">
            ...
            <Input id="c-benNom" placeholder="ex: AXA Assurances"
          ...
          {myProperties.length > 0 && (
            <div className="space-y-1.5">
              <Label htmlFor="c-prop">Propriété concernée (optionnel)</Label>
